...
question_db_loc = r"C:\Users\abdullah.jamal\Desktop\LMS\Quiz Running\db"
...
df = pd.read_excel(os.path.join(question_db_loc, "Result 2.xlsx"),sheet_name="Emloyees Data")
standard = pd.read_excel(os.path.join(question_db_loc, "Result 2.xlsx"),sheet_name="Standard")
window = Tk()
window.title('PTIS LMS')
