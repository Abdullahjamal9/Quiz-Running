...
def generate_certificate(emp_id, emp_name, test_date, status, template_type):
    ...
    try:
        ...
        # Employee name (increased font size to 36)
        old_name = 'Usman Waheed'
        new_name = emp_name
        replacements[old_name] = (new_name, corsiva_font, 36, fitz.TEXT_ALIGN_CENTER, (0,0,0), (1,1,1))

        # Dates (increased font size to 16)
        ...
        replacements[old_date] = (new_date, arial_font, 16, align_date, (0,0,0), (1,1,1))
        ...
        # Validity (increased font size to 16)
        ...
        replacements[old_validity] = (new_validity, arial_font, 16, align_valid, (0,0,0), (1,1,1))
